...
/**
 * Executes a binary reader to load a .dbf file and then creates a callback to
 * handle the result.
 ...
 *                   loading the file.
 */
 DBFParser.load = function(src, callback, onerror) {
  var reader = new FileReader();
  reader.responseType = 'arraybuffer';
  reader.onload = function(obj) {
      var d = new DBFParser().parse(obj.target.result, src);
    callback(d);
  };
